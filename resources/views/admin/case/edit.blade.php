...
@section('content')
    <div class="layui-fluid">
        <div class="layui-row">
            <form class="layui-form" method="post" action="{{route('admin.case.update',$case->id)}}">
                {{ csrf_field() }}
                @method('PUT')
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="username" name="name" required="" value="{{$case->name}}" lay-verify="required"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="phone" name="title" required="" value="{{$case->title}}" lay-verify="required"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_email" name="keywords" required="" value="{{$case->keywords}}" lay-verify="required"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <button type="button" class="layui-btn" id="test1">
                        <input type="hidden" name="pic" value="{{$case->pic}}">
 ...
 <div class="layui-upload-list">
                        <img class="layui-upload-img" src="{{$case->pic}}" id="demo1">
                        <p id="demoText"></p>
                      </div>
                </div>
                    ...
                    <div class="layui-input-inline">
                        <select id="shipping" name="casecategory_id" class="valid">
                            @foreach($categories as $category)
                                <option @if($category->id == $case->casecategory_id) selected @endif value={{$category->id}} >{{$category->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_pass" name="description" required="" value="{{$case->description}}" lay-verify="required"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:80%;background:#fff">
                        <!--<textarea class="layui-textarea" id="demo" name="content" style="display: none">{{$case->content}}</textarea>-->
