...
@section('content')
    <div class="layui-fluid">
        <div class="layui-row">
            <form class="layui-form" method="post" action="{{route('admin.product.update',$product->id)}}">
                {{ csrf_field() }}
                @method('PUT')
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="username" name="name" required="" value="{{$product->name}}" lay-verify="required"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="phone" name="title" required="" value="{{$product->title}}" lay-verify="required"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_email" name="keywords" required="" value="{{$product->keywords}}" lay-verify="required"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
 ...
 <div class="layui-upload-list">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-upload">
                        ...
                        <blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px; overflow: hidden">
                            <div class="layui-upload-list" id="aaa">
                                @if($pic_list==null)
                                @else
                    ...
                    <div class="layui-input-inline">
                        <select id="shipping" name="classify_id" class="valid">
                            @foreach($classifies as $classify)
                                <option @if($classify->id == $product->classify_id) selected @endif value={{$classify->id}} >{{$classify->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_pass" name="description" required="" value="{{$product->description}}" lay-verify="required"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item" >
                    ...
                    <div class="layui-input-inline" style="width:80%;background:#fff">
                        <!--<textarea class="layui-textarea" id="demo" name="trait" style="display: none">{{$product->trait}}</textarea>-->
                ...
                <div class="layui-form-item" >
                    ...
                    <div class="layui-input-inline" style="width:80%;background:#fff;">
                        <!--<textarea class="layui-textarea" id="demo1" name="parameter" style="display: none">{{$product->parameter}}</textarea>-->
        ...
        layui.use('upload', function(){
            ...
            upload.render({
                ...
                ,done: function(res){
                    //上传完毕
                    if (res.code == 0) {
                        $('#aaa').append('<li><span onclick="delImage(this)" class="mdi mdi-close"></span><img src="' + res.data.src + '" alt="" width="100px" class="layui-upload-img"><input type="hidden" name="pic_list[]" value="' + res.data.src + '"></li>')
                    } else {
