...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form" method="post" action="{{route('admin.classify.store')}}">
            {{ csrf_field() }}
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="username" name="introduce" required="" lay-verify="required"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="username" name="down" required="" lay-verify="required"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
