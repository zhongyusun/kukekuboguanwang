...
@section('keywords',"$advantage->keywords")
@section('description',"$advantage->description")
@section('content')
    ...
    <div class="crumbs-box max-box">
        <div class="ins-box">
            当前位置：<a href="/">首页</a><span> > </span><a href="{{route('index.advantages')}}">优势列表</a>
            <span> > </span><a href="{{route('index.advantage',$advantage->id)}}">{{$advantage->name}}</a>
        </div>
    </div>
            ...
            <div class="case-bottom-box" style="margin-bottom:50px">
                <div class="case-left-box">
                    <div class="left-title">
                        ...
                        <hr>
                        <ul>
                            <li>发布日期： {{$advantage->created_at}}</li>
                            <li>
                                <a href="{{route('index.advantages')}}">返回列表</a>
                            </li>
                        </ul>
                    </div>
                    <div class='desc-box'>
